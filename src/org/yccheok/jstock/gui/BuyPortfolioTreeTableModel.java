...
public class BuyPortfolioTreeTableModel extends DeprecatedAbstractPortfolioTreeTableModel {
    ...
    public boolean split(StockInfo stockInfo, double ratio) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (true == transaction.getContract().getCode().equals(stockInfo.code)) {
                break;
            }
        }
    ...
    public boolean updateStockLastPrice(Code code, double price) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (true == transaction.getContract().getCode().equals(code)) {
    ...
    public Object getValueAt(Object node, int column) {
        ...
        if (node instanceof TransactionSummary) {
            ...
            switch(column) {
                case 0:
                    return ((Transaction)transactionSummary.getChildAt(0)).getContract().getCode();
        ...
        if (node instanceof Transaction) {
            ...
            switch(column) {
                case 0:
                    return transaction.getContract().getCode();
    ...
    private Object readResolve() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            set.add(transaction.getContract().getCode());
        }
